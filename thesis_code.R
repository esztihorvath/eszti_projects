...
A = read.csv("C:/Users/dell/Desktop/szakdoga/kerdoivek/test_Egy_tenyleg_rovid_kerdoiv.csv", header = TRUE, sep = ';')
B = read.csv("C:/Users/dell/Desktop/szakdoga/kerdoivek/test_Rovid_kerdoiv.csv", header = TRUE, sep = ';')
